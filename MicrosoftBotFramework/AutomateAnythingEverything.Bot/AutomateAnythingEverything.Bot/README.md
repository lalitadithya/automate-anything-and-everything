# AutomateAnythingEverything.Bot
...
- In a terminal, navigate to `AutomateAnythingEverything.Bot`

    ```bash
    # change into project folder
    cd AutomateAnythingEverything.Bot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `AutomateAnythingEverything.Bot` folder
  - Select `AutomateAnythingEverything.Bot.csproj` file
